...
<div class="container">
    ...
    <div class="movie-card">
        <div class="movie-header manOfSteel"
             style="background: url('<?php echo $movie->getImage() ?>'); background-size: cover">
            <div class="header-icon-container">
                <a href="?page=xemphim&id=<?php echo $movie->getId() ?>">
        ...
        <div class="movie-content">
            <div class="movie-content-header">
                <a href="?page=xemphim&id=<?php echo $movie->getId(); ?>">
                    <h3 class="movie-title"><?php echo $movie->getTitle(); ?></h3>
                </a>
                <div class="imax-logo"
                ">
            </div>
        ...
        <div class="movie-info">
            ...
            <div>(<?php echo $movie->getYearRelease(); ?>)</div>
        </div>
    </div>
</div>
<?php endforeach; ?>
...
<div id="footer" style="background-color: #28312e;height: 100px;color: white;position: relative;bottom: 0">
